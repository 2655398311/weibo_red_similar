...
#
#     # 粉丝数量百分比，权重0.4
#     fans_bfb = (nextrow.fans_num.values[0] / currow.fans_num.values[0])*0.4
#     print('++++++++++++',nextrow.fans_num.values[0])
#     print('************',currow.fans_num.values[0])
#     # print(fans_bfb)
#
#     # 标签百分比，权重0.3
...
#
#     # 活跃粉丝百分比，权重0.2
#     active_bfb = (nextrow.active_fans.values[0] / currow.active_fans.values[0]) * 0.2
#     # 新增粉丝百分比，权重0.1
#     add_bfb = (nextrow.add_fans.values[0] / currow.add_fans.values[0]) * 0.1
#
#     # 百分比求和
...
line = {"platform_cid": [], "platform_cid_xs": [], "val": []}
for o, g in raw.items():
    for a, b in g.items():
        for pp in b:
            ...
            line['val'].append(pp[1])

df1 = pd.DataFrame(data=line)
print(df1)
# print(df1)
# df1.to_excel('bfb.xlsx')
